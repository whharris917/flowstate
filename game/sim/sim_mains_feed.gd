...
## at its voltage class, one per load (director, 2026-09-12: a
## terminal takes one cable, so a feeder that serves N loads has N
## ways). Load accounting and breakers arrive with the power-monitoring
