...
3. **Harbor town, open for the director:** what the domed hall is, the sign names, the town's name, the moon's phase (`SkyClock.MOON_AGE`), the noon sun's height (60°; October's is 33°).
